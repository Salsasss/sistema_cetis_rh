    ...
    if (formulario) {
        formulario.addEventListener('submit', function(e) {
            ...
            if (curpValida(curp.value) != true) {
                mensaje += '<li> CURP no reconocida <br> </li>';
            }
            ...
            if (!nssValido(nss.value)) {
                mensaje += '<li> NSS no reconocido <br> </li>';
            }
            ...
            if (rfcValida(rfc.value) != true) {
                mensaje += '<li> RFC no reconocido <br> </li>';
            }
            ...
            const grado = document.getElementById('id_grado_estudio');
            if (grado.value != '1' && grado.value != '2' && grado.value != '3') {
                mensaje += '<li> Grado de Estudios No V&aacute;lido <br> </li>';
            }
            ...
            if (horas.value >= 30 && grado.value == 1) {
            ...
            if (fecha_ingreso.value == '') {
                mensaje += '<li> La fecha de ingreso es Obligatoria <br> </li>';
            }
