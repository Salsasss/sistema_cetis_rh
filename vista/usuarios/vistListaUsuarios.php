    ...
    <div class="contenedor-grande">        
        <form class="formulario grande flex" action="index.php?opc=5&cambio=1" method="POST">        
            <div class="contenido-filtro buscador grande admin-usuarios">
                ...
                <a class="opcion redondo boton-verde tablet" href="?opc=12&acc=2">Nuevo Usuario</a>
            </div>
        </form>
    </div>
    ...
    <?php    
        ...
        if(empty($arregloPaginado)){
            if(isset($_POST['datoBuscar']) && isset($nomBuscar)){
                ?> <h3 class="centrar-texto">No se ha encontrado Ning&uacute;n Usuario de <?php
                ...
                ?> <h3 class="centrar-texto">Actualmente no hay Ning&uacute;n Usuario registrado en el sistema</h3><?php
            }
        }else{
            ?>
            ...
            <table class="tabla">
                ...
                foreach($arregloPaginado as $usuario){
                    ...
                    <td class="campo-tabla"> <p class="nombres-datos-mobile">Rango de la Cuenta:</p> <p> <?php echo $usuario->id_rango ?> </p> </td>
