    ...
    <form class="formulario nuevo-usuario" action="" method="POST">
        <fieldset>
            ...
            <select name="usuario[id_rango]" id="id_rango" required>
                ...
                <option value="1" <?php if(sanitizar($usuario->id_rango)=='1') echo 'selected'?> >Administrador</option>
                <option value="2" <?php if(sanitizar($usuario->id_rango)=='2') echo 'selected'?> >Asistente</option>
            </select>
        </fieldset>
