    ...
    <fieldset class="contenedor-fieldset">
        <div class="contenido-inicio">
            ...
            <div class="campo">
                ...
                <input class="password centrar-texto" id="password" type="password" maxlength="6" name="password" id="password" value="AI5OD5<?php if(isset($_POST['password'])&& !empty($_POST['password'])) //echo $_POST['password']?>" required>
            </div>
