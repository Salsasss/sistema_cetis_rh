...
<section class="seccion">
    ...
    $cantDocentes = $res->fetch_assoc()['COUNT(*)'];
    ...
    if(empty($arregloPaginado)){
        if(isset($_POST['datoBuscar']) && isset($nomBuscar)){
            ...
            ?> <h3 class="titulo">Actualmente no hay Ning&uacute;n Docente<?php
            switch($ver){
            ...
            ?> <h3 class="titulo">Actualmente no hay Ning&uacute;n Docente registrado en el sistema</h3><?php
        }
    }else{
        ?>
        <table class="tabla docentes">
            <tr class="fila cabecera titulo"><th colspan="24">Docentes en el Sistema</th></tr>
            <tr class="fila cabecera nombres-datos">
                ...
                <th class="direc">Estado</th>
                <th class="direc">Municipio</th>
                <th class="direc">Localidad</th>        
            ...
            foreach($arregloPaginado as $docente){
                ...
                <tr class="fila datos-docentes">
                    ...
                    <td class="campo-tabla"> <p class="nombres-datos-mobile">Tel&eacute;fono Celular:</p>  <p> <?php echo $docente->getTelefono(); ?> </p> </td>
                    <td class="campo-tabla direc"> <p class="nombres-datos-mobile">Estado:</p>  <p> <?php echo getEstado($docente->id_estado) ?> </p> </td>
                    <td class="campo-tabla direc"> <p class="nombres-datos-mobile">Municipio:</p>  <p> <?php echo getMunicipio($docente->id_municipio) ?> </p> </td>                    
                    <td class="campo-tabla direc"> <p class="nombres-datos-mobile">Localidad:</p>  <p> <?php echo getLocalidad($docente->id_localidad) ?> </p> </td>
                    ...
                    <td class="campo-tabla grado"> <p class="nombres-datos-mobile">Grado M&aacute;ximo de Estudios:</p>  <p> <?php echo getGradoEstudios($docente->id_grado_estudio) ?> </p> </td>
                    ...
                    <td class="acciones">
                        <div class="contenedor-acciones">
                            <p class="boton verde mostrar-acciones grande desktop"><img class="imagen-barras-acciones" src="multimedia/imagenes/barras.svg" alt=""></p>
                            <ul class="submenu">
                                ...
                                <li class="li-accion">                                        
                                    <div class="contenedor-acciones-reporte reportes">
                                        <p class="boton verde desktop">Generar Reporte PDF</p>
                                        <ul class="submenu-dos">
                                            ...
                                            <li class="li-accion"><a class="boton accion editar" href="vista/reportes/reportesPermisosPDF.php?id_docente=<?php echo $docente->id_docente ?>" target="_blank">Reporte de Permisos</a></li>
                                            <?php
